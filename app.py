...
app = Flask(__name__)
model = pickle.load(open('C:\\Users\\Neetu\\Desktop\\study material DS\\sabudh_assignment\\machine learning\\New folder\\lr_deploy\\model.pkl', 'rb'))
sc = pickle.load(open('C:\\Users\\Neetu\\Desktop\\study material DS\\sabudh_assignment\\machine learning\\New folder\\lr_deploy\\standardized1.pkl','rb'))
@app.route('/')
def home():
